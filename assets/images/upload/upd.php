...
<form action="entry.php" method="post" id="register" action="">
	<table>
		...
		<tr>
			...
			<td>
				 <textarea name="saddress" rows="5" cols="20"><?php echo $adds;?></textarea>
			</td>
		</tr>
	<tr>
		<td>
...
<tr>
	...
	<td>
		<input type="text" name="fathername" id="name" placeholder="Enter Father's name"  value="<?php echo $faname;?>">
	</td>
	<td>
...
<tr>
	...
	<td>
		<input type="password" name="passwd" id="pass" placeholder="Enter Password">
	</td>
	<td>
		<label>Re-enter Password:</label>
	</td>
	<td>
		<input type="password" name="rpasswd" id="pass" placeholder="Re-Enter Password">
...
<tr>
	...
	<td>
		<input type="text" name="depart" id="dept" placeholder="Enter Department" value="<?php echo $desig;?>"></td>
		<td>
			<label>Semester:</label>
		</td>

		<td>
			<input type="number" name="sem" id="sem" placeholder="Enter Semester"  value="<?php echo $sem;?>">
		</td>
	</tr>
	<tr>
		<td colspan="3">
